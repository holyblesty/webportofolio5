...
$sql2 = "SELECT * FROM nilai WHERE id_portofolio = ?";
$stmt2 = $conn->prepare($sql2);
$stmt2->bind_param("i", $id_portofolio);
$stmt2->execute();
...
<form action="proses_nilai.php" method="POST">
    ...
    <input type="number" name="nilai" min="0" max="100"
           value="<?= $nilai['nilai'] ?>" required><br><br>

    Catatan:<br>
    <textarea name="catatan" rows="4"><?= $nilai['catatan'] ?></textarea><br><br>

    <button type="submit">Perbarui Nilai</button>
</form>
